...
{
	public:
		signed char red; /**< Byte for the red component of the pixel. */
		signed char green; /**< Byte for the green component of the pixel. */
		signed char blue; /**< Byte for the blue component of the pixel. */
		signed char alpha; /**< Byte for the alpha component of the pixel. */
		 ...
		 */
		RGBAPixel(signed char red, signed char green, signed char blue);
