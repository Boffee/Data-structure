...
int main()
{
    ...
    set->addpicture("in_03.png", 5, 30, 50);
    set->addpicture("in_01.png", 8, 30, 50);
    set->addpicture("in_01.png", -1, 30, 50);
    set->changemaxlayers(6);
    cout << set->imageCap <<endl;
    set->changelayer(1,1);
    set->changelayer(1,5);
    set->changelayer(2,-5);
    set->changelayer(-1,2);
    
    set->translate(1, 10, 30);
    set->translate(-1, 0, 0);
    set->translate(10, 4, 5);
